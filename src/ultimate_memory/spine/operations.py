...
from ultimate_memory.model import CurrencyLedgerAudit
from ultimate_memory.model import CurrencyMismatch
from ultimate_memory.model import DeadLetterGroup
from ultimate_memory.model import DeadLetterRecord
from ultimate_memory.model import DeadLetterReport
from ultimate_memory.model import OperationalReport
from ultimate_memory.model import PipelineRouteStatus
from ultimate_memory.model import PoisonTargetRecord
from ultimate_memory.model import PoisonTargetReport
from ultimate_memory.model import ProjectionSnapshotState
...
class OperationalSettings(BaseSettings):
    ...
    model_config = SettingsConfigDict(env_prefix="UGM_OPERATIONAL_", extra="ignore")
