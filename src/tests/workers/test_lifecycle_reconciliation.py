...
from ultimate_memory.workers import CycleFinalizer
...
from ultimate_memory.workers import RECONCILE_VERSION
from ultimate_memory.workers import ReconcileHandler
...
def database_engine() -> Iterator[Engine]:
    ...
    try:
        ...
        pytest.skip("UGM_DATABASE_URL is required for real PostgreSQL lifecycle proofs")
