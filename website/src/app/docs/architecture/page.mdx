export const metadata = {
  title: "Architecture",
  description:
    "How Ultimate Memory's three planes fit together: the evidence pipeline (E0–E3), the knowledge plane (K), and the projections (P1–P3) agents actually consume.",
};
...
This page is the map. The binding design — every mechanism, schema, and decision with its rationale — lives in the repository under [`plan/`](https://github.com/writeitai/ultimate-memory/tree/main/plan), anchored by the [architecture decision log](https://github.com/writeitai/ultimate-memory/blob/main/decisions.md). As implementation lands, each subsystem gets its own page here.
