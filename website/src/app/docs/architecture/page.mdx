...
This page is the map. The binding design — every mechanism, schema, and decision with its rationale — lives in the repository under [`plan/`](https://github.com/writeitai/rememberstack/tree/main/plan), anchored by the [architecture decision log](https://github.com/writeitai/rememberstack/blob/main/decisions.md). As implementation lands, each subsystem gets its own page here.
