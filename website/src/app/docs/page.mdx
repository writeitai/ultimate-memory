export const metadata = {
  title: "Introduction",
  description:
    "Ultimate Memory is a memory system for AI agents: millions of heterogeneous documents distilled into auditable evidence, adjudicated facts, and compiled knowledge.",
};
