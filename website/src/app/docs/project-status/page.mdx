...
- **The complete design** — in [`plan/`](https://github.com/writeitai/rememberstack/tree/main/plan): requirements, binding per-subsystem designs, the research and analyses behind them, and a build-order roadmap.
- **The decision log** — [`decisions.md`](https://github.com/writeitai/rememberstack/blob/main/decisions.md): every architecture decision (D1, D2, …) with context, rationale, and its later refinements. If you want to know *why* something is the way it is, start there.
- **Design-conformance evals** — a suite of acceptance checks (in [`plan/implementation_evals/`](https://github.com/writeitai/rememberstack/tree/main/plan/implementation_evals)) that judge the implementation against the binding design as it lands.
...
Implementation follows [`plan/plans/roadmap.md`](https://github.com/writeitai/rememberstack/blob/main/plan/plans/roadmap.md) — nine phases, each keyed to the designs it realizes:
...
- Watch the [GitHub repository](https://github.com/writeitai/rememberstack) — work lands as reviewed pull requests referencing roadmap work packages.
- Read the [decision log](https://github.com/writeitai/rememberstack/blob/main/decisions.md) for the ideas; skim merged PRs for the build.
